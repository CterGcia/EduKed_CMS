...
<head>
    ...
    <title>EduKed CMS - Credentials Missing</title>
    <!-- Fonts -->
...
<body>
    <div class="login-container">
        <div class="error-box">
            ...
            <h1 style="font-size: 1.4rem; margin-bottom: 0.5rem; color: var(--neo-text);">Empty Credentials</h1>
            <p style="margin-bottom: 1.5rem; font-size: 0.9rem;">You did not provide username or password credentials. Both input parameters are mandatory to authenticate.</p>
